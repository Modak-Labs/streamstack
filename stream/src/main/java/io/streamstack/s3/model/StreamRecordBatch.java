...
package io.streamstack.s3.model;

import io.streamstack.s3.ByteBufSupplier;
import io.streamstack.utils.search.ComparableItem;
...
import static io.streamstack.s3.StreamRecordBatchCodec.BASE_OFFSET_POS;
import static io.streamstack.s3.StreamRecordBatchCodec.EPOCH_POS;
import static io.streamstack.s3.StreamRecordBatchCodec.HEADER_SIZE;
import static io.streamstack.s3.StreamRecordBatchCodec.LAST_OFFSET_DELTA_POS;
import static io.streamstack.s3.StreamRecordBatchCodec.MAGIC_POS;
import static io.streamstack.s3.StreamRecordBatchCodec.MAGIC_V0;
import static io.streamstack.s3.StreamRecordBatchCodec.PAYLOAD_LENGTH_POS;
import static io.streamstack.s3.StreamRecordBatchCodec.PAYLOAD_POS;
import static io.streamstack.s3.StreamRecordBatchCodec.STREAM_ID_POS;
