...
import io.streamstack.utils.search.AbstractOrderedCollection;
...
import static io.streamstack.s3.ByteBufAlloc.BLOCK_CACHE;
import static io.streamstack.s3.CompositeObject.FOOTER_MAGIC;
import static io.streamstack.s3.CompositeObject.OBJECTS_BLOCK_MAGIC;
import static io.streamstack.s3.CompositeObject.OBJECT_BLOCK_HEADER_SIZE;
import static io.streamstack.s3.CompositeObject.OBJECT_UNIT_SIZE;
import static io.streamstack.s3.ObjectWriter.Footer.FOOTER_SIZE;
import static io.streamstack.s3.operator.ObjectStorage.RANGE_READ_TO_END;
