...
import static io.streamstack.s3.ByteBufAlloc.STREAM_SET_OBJECT_COMPACTION_READ;
import static io.streamstack.s3.operator.Writer.MIN_PART_SIZE;
...
public class DataBlockWriter {
    ...
    public void write(StreamDataBlock dataBlock) {
        ...
        cf.whenComplete((nil, ex) -> CompactionMetrics.COMPACTION_WRITE_SIZE.add(dataBlock.getBlockSize()));
